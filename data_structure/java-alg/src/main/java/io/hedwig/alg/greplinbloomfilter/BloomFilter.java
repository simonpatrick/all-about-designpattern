...
import io.hedwig.alg.greplinbloomfilter.allocator.Allocator;
import io.hedwig.alg.greplinbloomfilter.allocator.CloseCallback;
...
public class BloomFilter implements Closeable {
    ...
    public static final Allocator DEFAULT_ALLOCATOR = size -> new byte[size];
