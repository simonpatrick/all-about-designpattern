package io.hedwig.designpattern;
...
//    - write to file and use command to generate png file
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        String path = SimpleGenerator.class.getClassLoader().getResource("").getPath() +
                "io/hedwig/designpattern";
        String basePackageName = "io.hedwig.designpattern";
